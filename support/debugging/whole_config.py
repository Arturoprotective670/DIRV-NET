...
class WholeConfig(Config):
    ...
    def __init__(self, session_id: Optional[str] = None) -> None:
        ...
        self.max_used_gpu_memory: Optional[float] = 4  # None to allocate all memory
        ...
        self.crop_input_dataset_size_to: Optional[int] = 2
        self.crop_test_dataset_size_to: Optional[int] = 2
        ...
        self.convolutional_kernels_count = 24  # number of filters in the convolution
        ...
        self.potentials_parametrization_mode = PotentialsParametrizationModes.PIECE_WISE_LINEAR
        ...
        self.training_batch_size: int = 5
        self.validation_default_batch_size: int = 1
        self.testing_default_batch_size: int = 1
        ...
        self.non_rigid_max_magnitude_range: Tuple[float, float] = (0.3, 4.2)
        ...
        self.flash_text_logs_every_lines: int = 5
        ...
        self.save_model_variables_every_epochs: int = 3
        # for the last x epochs, save variables every epoch
        self.save_model_variables_for_last_epochs: int = 2
